...
typedef struct AVPixelFormatTag {
	AVPixelFormat AV_PIX_FMT;
    unsigned int fourcc;
} AVPixelFormatTag;

static const AVPixelFormatTag AVPixelFormatTags[] = {
	/* Planar formats */
    { AV_PIX_FMT_YUV420P, 	FOURCC('I', '4', '2', '0') },
    { AV_PIX_FMT_YUV420P, 	FOURCC('I', 'Y', 'U', 'V') },
    { AV_PIX_FMT_YUV420P, 	FOURCC('Y', 'V', '1', '2') },
    { AV_PIX_FMT_YUV410P, 	FOURCC('Y', 'U', 'V', '9') },
    { AV_PIX_FMT_YUV411P, 	FOURCC('Y', '4', '1', 'B') },
    { AV_PIX_FMT_YUV422P, 	FOURCC('Y', '4', '2', 'B') },
    { AV_PIX_FMT_GRAY8,   	FOURCC('Y', '8', '0', '0') },
    { AV_PIX_FMT_GRAY8,   	FOURCC(' ', ' ', 'Y', '8') },

    //v4l
    { AV_PIX_FMT_GRAY8,   	FOURCC('G', 'R', 'E', 'Y') },
    //{ AV_PIX_FMT_... 	FOURCC('H', '2', '4', '0') },	//HI420 BT848, seems to not exist in ffmpeg
    { AV_PIX_FMT_RGB565,  	FOURCC('R', 'G', 'B', '6') },	//RGB565
    { AV_PIX_FMT_RGB555 , 	FOURCC('R', 'G', 'B', '5') },	//RGB15
    { AV_PIX_FMT_RGB32,   	FOURCC('R', 'G', 'B', '4') },	//RGB32
    { AV_PIX_FMT_YUYV422, 	FOURCC('Y', 'U', 'Y', 'V') },
    { AV_PIX_FMT_UYYVYY411,FOURCC('Y', '4', '1', '1') },	//YUV411 is this correct??
    //FOURCC( 'R', 'A', 'W', ' ' );						//BT848, seems to not exist in ffmpeg
    { AV_PIX_FMT_YUV422P, 	FOURCC('Y', '4', '2', 'P') },	//YUV422P
    { AV_PIX_FMT_YUV411P, 	FOURCC('4', '1', '1', 'P') },	//YUV411P
    { AV_PIX_FMT_YUV420P, 	FOURCC('Y', 'U', '1', '2') },

    //v4l2
    { AV_PIX_FMT_UYVY422, 	FOURCC('U', 'Y', 'V', 'Y') },
    { AV_PIX_FMT_YUV411P, 	FOURCC('Y', '4', '1', 'P') },
    //{ AV_PIX_FMT_YVU410P, FOURCC('Y', 'V', 'U', '9') },
    { AV_PIX_FMT_YUV410P, 	FOURCC('Y', 'U', 'V', '9') }, 	// is this correct or YUV410 non-planar
    { AV_PIX_FMT_YUV422P, 	FOURCC('4', '2', '2', 'P') },
    { AV_PIX_FMT_YUV411P, 	FOURCC('4', '1', '1', 'P') },
    { AV_PIX_FMT_NV12,    	FOURCC('N', 'V', '1', '2') },
    { AV_PIX_FMT_NV21,    	FOURCC('N', 'V', '2', '1') },
#ifdef AV_PIX_FMT_YUV422
    { AV_PIX_FMT_YUV422,  	FOURCC('Y', 'Y', 'U', 'V') },
#endif
    { AV_PIX_FMT_RGB32_1, 	FOURCC('R', 'G', 'B', '1') },	// is this correct?
    { AV_PIX_FMT_RGB555,  	FOURCC('R', 'G', 'B', 'O') },
    { AV_PIX_FMT_RGB565,  	FOURCC('R', 'G', 'B', 'P') },
    //{ AV_PIX_FMT_RGB555X,  FOURCC('R', 'G', 'B', 'Q') },
    //{ AV_PIX_FMT_RGB565X,  FOURCC('R', 'G', 'B', 'R') },
    { AV_PIX_FMT_BGR32,   	FOURCC('B', 'G', 'R', '4') },

    //vid21394
    { AV_PIX_FMT_YUYV422, 	FOURCC('Y', 'U', 'Y', '2') },	// is this correct?
    { AV_PIX_FMT_GRAY8,   	FOURCC('Y', '8', '0', '0') },	// is this correct?

    /* dcam */
    { AV_PIX_FMT_YUV444P, 	FOURCC('Y', '4', '4', '4') }, 	// is this correct or non-planar?
    { AV_PIX_FMT_GRAY16,  	FOURCC('Y', '1', '6', '0') }, 	// is this correct?
    { AV_PIX_FMT_RGB24,   	FOURCC('R', 'G', 'B', ' ') },

    /* Packed formats */
    { AV_PIX_FMT_YUYV422, 	FOURCC('Y', 'U', 'Y', '2') },
    { AV_PIX_FMT_YUYV422, 	FOURCC('Y', '4', '2', '2') },
    { AV_PIX_FMT_UYVY422, 	FOURCC('U', 'Y', 'V', 'Y') },
    { AV_PIX_FMT_GRAY8,   	FOURCC('G', 'R', 'E', 'Y') },
    { AV_PIX_FMT_RGB555,  	FOURCC('R', 'G', 'B', 15) },
    { AV_PIX_FMT_BGR555,  	FOURCC('B', 'G', 'R', 15) },
    { AV_PIX_FMT_RGB565,  	FOURCC('R', 'G', 'B', 16) },
    { AV_PIX_FMT_BGR565,  	FOURCC('B', 'G', 'R', 16) },
    { AV_PIX_FMT_BGR24,   	FOURCC('B', 'G', 'R', '3') },
    { AV_PIX_FMT_RGB24,   	FOURCC('R', 'G', 'B', '3') },

    /* quicktime */
    { AV_PIX_FMT_UYVY422, 	FOURCC('2', 'v', 'u', 'y') },
    { AV_PIX_FMT_UYVY422, 	FOURCC('A', 'V', 'U', 'I') },
...
//--------------------------------------------------------------------
AVPixelFormat fourcc_to_pix_fmt( unsigned int fourcc)
{
	const AVPixelFormatTag * tags = PixelFormatTags;
...
void ofUCUtils::set_format(int w, int h) {
	...
	if (format_count > 0) {
		...
		if(src_pix_fmt!=AV_PIX_FMTRGB24 || !exactMatch){
			doConversion = true;
			src=new AVPicture;
			avpicture_alloc(src,static_cast<AVPixelFormat>(src_pix_fmt),format.size.width,format.size.height);
			dst=new AVPicture;
			avpicture_alloc(dst,AV_PIX_FMTRGB24,d_width,d_height);

			toRGB_convert_ctx = sws_getContext(
							format.size.width, format.size.height, static_cast<AVPixelFormat>(src_pix_fmt),
							d_width, d_height, AV_PIX_FMT_RGB24,
...
void ofUCUtils::new_frame (unicap_data_buffer_t * buffer)
{
	...
	if(doConversion){
		avpicture_fill(src,buffer->data,static_cast<AVPixelFormat>(src_pix_fmt),format.size.width,format.size.height);
		...
		lock_buffer();
			avpicture_layout(dst,AV_PIX_FMTRGB24,d_width,d_height,pixels,d_width*d_height*3);
